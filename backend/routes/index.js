...
// const city = ['Paris','Rome','Madrid'];
// for(var x ; x > city.length ; x++){
// api_url.push(city)
// }

// const api_url = `https://api.foursquare.com/v2/venues/explore?&near=${city}&client_id=2ZMTPBXCGV2PP1CS0X5UJ4ZTWIN10HC1KLK5M4JMS0KRP5DR&client_secret=30Q1DHT014WDKXP5B0T2D1DEGMZY2WPQRB1UI2P1EBUILPXM&v=20180323&query=food`
